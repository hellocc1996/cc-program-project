package com.program.enums;

/**
 * Created by zhengkk19738 on 2018/5/3.
 */
public enum ErrorCode {
    SYSTEM_ERROR(500, "系统错误"),
    PARAMETER_CHECK_ERROR(400, "参数校验错误"),
    AUTH_VALID_ERROR(701, "无权访问"),
    UNLOGIN_ERROR(401, "Sorry, You're not authorized to access this resource."),;
